...
test('manual proximity cannot fake resistance turned support',()=>{const e=C.analyzeKlines(rangeBars(80),'15m');e.isBreakout=true;e.breakoutLevel=1810;e.firstSupport={price:1810,source:'swing',confidence:'high',clusterId:8};e.swingLows=[];assert.notEqual(C.buildSRZones(e).supportZones[0].sourceLabel,'历史压力转支撑');});
