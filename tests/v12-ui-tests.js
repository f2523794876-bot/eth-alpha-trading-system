...
test('v1-core冻结哈希（决策日志容量保护与安全读取修订）',()=>assert.equal(crypto.createHash('sha256').update(fs.readFileSync(path.join(__dirname,'../v1-core.js'))).digest('hex'),'87588d1f6d92c215ed1eac2c0e43691b4c9b6d27f2f6553b6481ef2b0b7d6537'));
