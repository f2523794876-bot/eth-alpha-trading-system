...
test('v1-core冻结哈希（P0因果ATR与结构化入场区修订）',()=>assert.equal(crypto.createHash('sha256').update(fs.readFileSync(path.join(__dirname,'../v1-core.js'))).digest('hex'),'02f78469ef9ec1a2998a44b87fd3e5b965b6929ed2d062930ec80c21ea8f0b14'));
