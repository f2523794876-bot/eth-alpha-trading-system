...
test('v1-core冻结哈希（P0因果ATR与结构化入场区修订）',()=>assert.equal(crypto.createHash('sha256').update(fs.readFileSync(path.join(__dirname,'../v1-core.js'))).digest('hex'),'edc36248440cd53443b798a9aa5ad769904b986068172ecc4590aafbe486ed00'));
