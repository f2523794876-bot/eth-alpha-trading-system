...
- `v1-core.js` SHA-256：`0a4d9e712859d79ecae592aacffe371abfba29a2c6b7b76119a68c49e0471a97`
...
- 当前浏览器自动化环境的 URL 安全策略禁止直接打开 `file://`，因此真实双击 Chrome 人工验收记录为待完成；没有以静态或 Node 测试冒充人工验收。
- 本轮真实行情中，BTC 15m 窗口触发 V1.1 既有异常 K 线阈值，导致四个既有 V1.2/V1.3 实时“必须健康”测试安全阻断。V1.4 独立服务器时间与生产链测试 15 项全部通过；未修改旧核心或伪造健康状态。
