...
- 不实现模拟仓位追踪、条件提醒推送。（v1.3范围调整说明：模拟仓位追踪已于v1.3阶段拆出单独实现，不再属于V3范围，见`V1_3_PAPER_TRADING_SPEC.md`；本条对V1.2阶段本身的历史约束不变，条件提醒推送范围不变。）
...
6. 禁止实现V2回测引擎、WebSocket、条件提醒推送、模拟仓位追踪（V2/V3范围；v1.3范围调整说明：模拟仓位追踪已于v1.3阶段拆出单独实现，不再属于V3范围，见`V1_3_PAPER_TRADING_SPEC.md`，本条对V1.2阶段本身的历史约束不变）。
